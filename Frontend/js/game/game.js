...
const SoundManager = {
    isMuted: false,
    sounds: {},
    // NOTA: Caminhos alterados para absolutos para evitar problemas ao carregar dinamicamente.
    // Você talvez precise ajustar este caminho dependendo da estrutura real dos seus arquivos.
    soundFiles: {
        play_card: '/Frontend/assets/sfx/play_card.wav',
        draw_card: '/Frontend/assets/sfx/draw_card.wav',
        button_click: '/Frontend/assets/sfx/button_click.wav',
        shuffle: '/Frontend/assets/sfx/shuffle.wav',
        win: '/Frontend/assets/sfx/win_game.mp3',
        lose: '/Frontend/assets/sfx/lose_game.mp3',
        error: '/Frontend/assets/sfx/error.wav'
    },
    init() {
